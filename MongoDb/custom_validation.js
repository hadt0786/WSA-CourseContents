...
tags:{
    type:Array,
    validate:{
       // function returns false-> validation failed
        //function returns true --> validation suucessful
        validator:function(val){
            return val.length >0// [] -- fase, 1,2,3, true
...
async function createCourse(){
    const course = new Course({
        ...
        tags:[], //false bealuse length is smaller than 0
        isPublished:true,
